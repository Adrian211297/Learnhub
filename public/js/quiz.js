document.addEventListener('DOMContentLoaded', () => {
    ...
    descriptionEl.parentElement.insertBefore(counterEl, descriptionEl);
...
quizQuestions.push({ course: randomCourse, type: questionType });
    ...
    function nextQuestion() {
      ...
      if (type === 'description') {
        ...
        descriptionEl.textContent = `Q${currentQuestion + 1}: Which course is taught by ${course.instructor}?`;
      }
